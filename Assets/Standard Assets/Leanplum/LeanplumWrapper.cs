...
//        }
		...
		LeanplumSDK.Leanplum.SetGcmSenderId (Leanplum.LeanplumGcmSenderId);

		LeanplumSDK.Leanplum.SetDeviceId("user7");


		Leanplum.Started += delegate {
			Leanplum.SetUserId ("newUser2");
		};
